...
export type GuardianIcon = '[damage]' | '[block]' | '[vigor]' | '[energy]' | '[dazed]' | '[debuff]' | '[weak]' | '[aoe]' | '[hp]' | '[remove]'
...
export const GUARDIAN_SOURCE_CARDS: readonly GuardianSourceCard[] = [
  ...
  {"deck":"rewards","rarity":"reward","name":"Overload","type":"Skill","cost":{"base":"1","upgraded":"1"},"sheet_indices":{"base":[2],"upgraded":[2]},"multiplicity":1,"base_text":"Draw 4 cards. [dazed].","upgraded_text":"Draw 5 cards. [dazed].","ocr_uncertainty":null},
  {"deck":"rewards","rarity":"reward","name":"Prismatic Barrier","type":"Gem Skill","cost":{"base":"1","upgraded":"1"},"sheet_indices":{"base":[3],"upgraded":[3]},"multiplicity":1,"base_text":"1 [block] to any player. All [damage], [weak], [debuff] on this card have [aoe]. Socket.","upgraded_text":"2 [block] to any player. All [damage], [weak], [debuff] on this card have [aoe]. Socket.","ocr_uncertainty":"The three icon tokens and burst token were verified visually; semantic aliases are descriptive."},
  {"deck":"rewards","rarity":"reward","name":"Prismatic Spray","type":"Gem Attack","cost":{"base":"1","upgraded":"1"},"sheet_indices":{"base":[4],"upgraded":[4]},"multiplicity":1,"base_text":"[aoe] 1 [damage]. All [damage], [weak], [debuff] on this card have [aoe]. Socket.","upgraded_text":"[aoe] 2 [damage]. All [damage], [weak], [debuff] on this card have [aoe]. Socket.","ocr_uncertainty":"The three icon tokens were verified visually; semantic aliases are descriptive."},
  ...
  {"deck":"rewards","rarity":"reward","name":"Stasis Field","type":"Skill","cost":{"base":"3","upgraded":"3"},"sheet_indices":{"base":[6],"upgraded":[6]},"multiplicity":1,"base_text":"1 [block], 1 [block], 1 [block], 1 [block]. Each [block] can target a different player. Exhaust.","upgraded_text":"1 [block], 1 [block], 1 [block], 1 [block], 1 [block]. Each [block] can target a different player. Exhaust.","ocr_uncertainty":null},
  ...
  {"deck":"rewards","rarity":"reward","name":"Sentry Beam","type":"Attack","cost":{"base":"2","upgraded":"2"},"sheet_indices":{"base":[8],"upgraded":[8]},"multiplicity":1,"base_text":"[aoe] 3 [damage]. Attack Mode: [vigor] [dazed].","upgraded_text":"[aoe] 4 [damage]. Attack Mode: [vigor] [dazed].","ocr_uncertainty":"Attack Mode consists only of two printed icons."},
  ...
  {"deck":"rewards","rarity":"reward","name":"Turbocharge","type":"Power","cost":{"base":"2","upgraded":"1"},"sheet_indices":{"base":[41],"upgraded":[41]},"multiplicity":1,"base_text":"End of turn: If you are in Attack Mode, [vigor]. Otherwise, Exhaust this card.","upgraded_text":"End of turn: If you are in Attack Mode, [vigor]. Otherwise, Exhaust this card.","ocr_uncertainty":null},
  ...
  {"deck":"rewards","rarity":"reward","name":"Repulsor","type":"Power","cost":{"base":"1","upgraded":"0"},"sheet_indices":{"base":[56],"upgraded":[56]},"multiplicity":1,"base_text":"When played, [dazed]. Start of turn: Gain [energy].","upgraded_text":"When played, [dazed]. Start of turn: Gain [energy].","ocr_uncertainty":null},
  ...
  {"deck":"rares","rarity":"rare","name":"Body Crash","type":"Attack","cost":{"base":"1","upgraded":"0"},"sheet_indices":{"base":[1],"upgraded":[1]},"multiplicity":1,"base_text":"Pay X [block]. X [damage], X [damage].","upgraded_text":"Pay X [block]. X [damage], X [damage].","ocr_uncertainty":null},
  ...
  {"deck":"rares","rarity":"rare","name":"Refracted Beam","type":"???","cost":{"base":"0","upgraded":"0"},"sheet_indices":{"base":[14],"upgraded":[14]},"multiplicity":1,"base_text":"Attack Mode: 0 [damage], 0 [damage], 0 [damage]. This is an Attack. Defense Mode: 0 [block], 0 [block], 0 [block]. This is a Skill.","upgraded_text":"Attack Mode: 0 [damage], 0 [damage], 0 [damage], 0 [damage]. This is an Attack. Defense Mode: 0 [block], 0 [block], 0 [block], 0 [block]. This is a Skill.","ocr_uncertainty":"Printed type plaque is literally '???'."},
  ...
  {"deck":"gems","rarity":"gem","name":"Garnet","type":"Gem","cost":{"base":null,"upgraded":null},"sheet_indices":{"base":[4,5],"upgraded":[]},"multiplicity":2,"base_text":"[debuff] [dazed].","upgraded_text":null,"ocr_uncertainty":"Effect consists of two icons only; aliases are descriptive."},
  ...
  {"deck":"gems","rarity":"gem","name":"Tourmaline","type":"Gem","cost":{"base":null,"upgraded":null},"sheet_indices":{"base":[12,13],"upgraded":[]},"multiplicity":2,"base_text":"[vigor]. Spend that [vigor] immediately.","upgraded_text":null,"ocr_uncertainty":null},
  ...
  {"deck":"gems","rarity":"gem","name":"Aquamarine","type":"Gem","cost":{"base":null,"upgraded":null},"sheet_indices":{"base":[16],"upgraded":[]},"multiplicity":1,"base_text":"[vigor]. You can't play additional cards this turn.","upgraded_text":null,"ocr_uncertainty":null},
...
function engineFace(card: GuardianSourceCard, upgraded: boolean): Partial<GuardianLiveCardDef> {
  ...
  return {
    ...
    effects: card.type === 'Gem'
      ? [{ kind: 'sequence', effects: [], guardianGemId: cardId(card.name) }]
      : [{ kind: 'sequence', effects: [], guardianAction: 'card' }],
    exhaust: card.type !== 'Power' && text?.includes('Exhaust') === true,
