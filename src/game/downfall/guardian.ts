...
export const GUARDIAN_SOURCE_CARDS: readonly GuardianSourceCard[] = [
  ...
  {"deck":"rewards","rarity":"reward","name":"Overload","type":"Skill","cost":{"base":"1","upgraded":"1"},"sheet_indices":{"base":[2],"upgraded":[2]},"multiplicity":1,"base_text":"Draw 4 cards. [mode-shift].","upgraded_text":"Draw 5 cards. [mode-shift].","ocr_uncertainty":null},
