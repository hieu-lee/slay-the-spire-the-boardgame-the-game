...
export type RelicDef = {
  ...
  pool: 'starting' | 'ordinary' | 'boss' | 'solo'
...
ordinary({ id: 'bag_of_preparation', name: 'Bag of Preparation', cost: 7,
  ...
  text: 'Start of combat: draw 2 cards.' })
ordinary({ id: 'bird_faced_urn', name: 'Bird-Faced Urn', cost: 8,
...
ordinary({ id: 'dead_branch', name: 'Dead Branch', cost: 8, effects: [], activation: 'oncePerCombat',
...
ordinary({ id: 'gambling_chip', name: 'Gambling Chip', cost: 5, effects: [], activation: 'oncePerRoom',
...
ordinary({ id: 'ink_bottle', name: 'Ink Bottle', cost: 5,
...
ordinary({ id: 'meat_on_the_bone', name: 'Meat on the Bone', cost: 5, effects: [],
...
ordinary({ id: 'mercury_hourglass', name: 'Mercury Hourglass', cost: 5,
...
ordinary({ id: 'mummified_hand', name: 'Mummified Hand', cost: 8, effects: [], activation: 'oncePerCombat',
  rule: 'Gain 2 Energy if you played a Power this turn.',
  text: 'Once per combat: gain 2 Energy if you played a Power this turn.' })
ordinary({ id: 'mutagen', name: 'Mutagen', cost: 5,
...
ordinary({ id: 'ninja_scroll', name: 'Ninja Scroll', cost: 7, effects: [], activation: 'oncePerCombat',
...
ordinary({ id: 'pocketwatch', name: 'Pocketwatch', cost: 8,
...
ordinary({ id: 'red_skull', name: 'Red Skull', cost: 8, effects: [], activation: 'oncePerCombat',
...
ordinary({ id: 'regal_pillow', name: 'Regal Pillow', cost: 5, effects: [],
...
ordinary({ id: 'toolbox', name: 'Toolbox', cost: 6, effects: [], activation: 'oncePerRoom',
...
ordinary({ id: 'whetstone', name: 'Whetstone', cost: 8, effects: [],
...
export const POTIONS: Record<string, PotionDef> = {
  ...
  fairy_in_a_bottle: {
    id: 'fairy_in_a_bottle', name: 'Fairy in a Bottle', quantity: 1, cost: 4,
    effects: [],
  ...
  purity: {
    id: 'purity', name: 'Purity', quantity: 1, cost: 2,
    effects: [{ kind: 'exhaustAny', amount: 3 }],
    text: 'Exhaust up to 3 cards from your hand.',
  },
  skill_potion: {
    id: 'skill_potion', name: 'Skill Potion', quantity: 1,
...
export const POTION_DECK: string[] = Object.values(POTIONS)
  .flatMap((potion) => Array.from({ length: potion.quantity }, () => potion.id))
