...
export function RewardScreen({ players, rewards, onReveal, onRevealPotion, onPotion, onRelic, onBossRelic, onResolve, potionLimit }: RewardScreenProps) {
  ...
  const settled = rewards.every((offer) => (!offer.cardReward || offer.playerId in decisions) &&
