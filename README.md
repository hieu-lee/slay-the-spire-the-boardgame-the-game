...
The repository includes original generated combat art for the four characters, eleven enemies
and stages, 251 text-free character-card illustrations, and the curated rulebook portraits used
by all remaining enemies. Clean clones therefore render complete cards and encounters. Optional
publisher card scans and rulebook icons are fetched locally by `pnpm sync:assets`.
...
| Enemy portraits | enemy card scans in the same PDF | 82 committed curated crops; not regenerated by sync |
