...
| Cursor assets (`public/assets/ui/cursor*.png`) | The normal cursor is an OpenAI `gpt-image-2` transparent extraction from a user-supplied cursor reference; the click state is a deterministic 10° left rotation of that same asset. |
