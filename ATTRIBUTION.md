...
| Cursor assets (`public/assets/ui/cursor*.png`) | Gold beveled pointer recreated in Blender from the user-supplied real-game reference (Screenshot 2026-09-11 at 13.24.38.png). Stable 64px transparent renders; pressed state rotates 10° left around the same tip/hotspot. Reproduce with `scripts/render-cursor.py`. |
