...
assert.match(workflow, /VITE_ASSET_CDN_ORIGIN="https:\/\/cdn\.jsdelivr\.net\/gh\/\$GITHUB_REPOSITORY@\$DEPLOY_SHA\/public\/assets" VITE_SINGLE_PLAYER=false VITE_HOSTED_SESSION=true pnpm build/)
...
assert.match(workflow, /du -sb dist[\s\S]*-lt 1000000000/)
